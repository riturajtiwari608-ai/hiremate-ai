...
def generate_interview_pdf(result, user):
    """
    result -> InterviewResultResponse data
    user -> Logged in candidate
    """
    ...
    # Title
    story.append(Paragraph("HireMate AI", title_style))
    story.append(
        Paragraph("AI Mock Interview Report", heading_style)
    )
    story.append(Spacer(1, 0.25 * inch))

    # Candidate
    story.append(Paragraph("<b>Candidate Details</b>", heading_style))
    story.append(Paragraph(f"Name : {user.full_name}", normal))
    story.append(Paragraph(f"Email : {user.email}", normal))
    story.append(Paragraph(f"Interview : {result['title']}", normal))
    story.append(Spacer(1, 0.25 * inch))

    # Scores
    story.append(Paragraph("<b>Overall Scores</b>", heading_style))

    story.append(
        Paragraph(
            f"Overall Score : <b>{result['average_score']}%</b>",
            normal,
        )
    )
    ...
    story.append(
        Paragraph(
            f"Technical : {result['average_technical_score']}%",
            normal,
        )
    )
    ...
    story.append(
        Paragraph(
            f"Communication : {result['average_communication_score']}%",
            normal,
        )
    )
    ...
    story.append(
        Paragraph(
            f"Confidence : {result['average_confidence_score']}%",
            normal,
        )
    )
    ...
    story.append(
        Paragraph(
            f"<b>Overall Feedback</b><br/>{result['overall_feedback']}",
            normal,
        )
    )
    ...
    story.append(
        Paragraph(
            f"<b>Recommendation</b><br/>{result['final_recommendation']}",
            normal,
        )
    )
    ...
    story.append(Paragraph("<b>Answer Evaluation</b>", heading_style))
    ...
    for index, answer in enumerate(result["answers"], start=1):
        ...
        story.append(
            Paragraph(f"<b>Question:</b> {answer.question}", normal)
        )

        story.append(
            Paragraph(f"<b>Your Answer:</b> {answer.answer}", normal)
        )

        story.append(
            Paragraph(f"<b>Score:</b> {answer.score}%", normal)
        )

        story.append(
            Paragraph(
                f"<b>Technical:</b> {answer.technical_score}%",
                normal,
            )
        )
        ...
        story.append(
            Paragraph(
                f"<b>Communication:</b> {answer.communication_score}%",
                normal,
            )
        )
        ...
        story.append(
            Paragraph(
                f"<b>Confidence:</b> {answer.confidence_score}%",
                normal,
            )
        )
        ...
        story.append(
            Paragraph(
                f"<b>Strengths:</b> {answer.strengths}",
                normal,
            )
        )
        ...
        story.append(
            Paragraph(
                f"<b>Weaknesses:</b> {answer.weaknesses}",
                normal,
            )
        )
        ...
        story.append(
            Paragraph(
                f"<b>Feedback:</b> {answer.feedback}",
                normal,
            )
        )
        ...
        story.append(
            Paragraph(
                f"<b>Improvement Tip:</b> {answer.improvement_tip}",
                normal,
            )
        )
    ...
    story.append(
        Paragraph(
            "<br/><br/>Generated by HireMate AI v3.3",
            styles["Italic"],
        )
    )
